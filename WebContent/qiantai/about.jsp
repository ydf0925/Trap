...
<body>
	...
	<div class="center clearfix">
		<div class="ab-left l">
			<div class="ab-left-t">
				<div class="ab-left-t2">公司简介</div>
				<div class="ab-left-nav clearfix">
					<ul>
						<LI><a
							href="${pageContext.request.contextPath}/AboutServlet?page=1&rows=500&ab=1"
							class="xz">公司简介</a></LI>
...
让客户满意是我们的宗旨。公司自成立以来始终秉持 “富于创造的设计理念 、诚恳热忱的服务态度 、积极进取的事业精神 、诚实守信的企业信誉”的经营战略，以优质的产品系列、完善的解决方案、雄厚的技术实力、先进的管理模式和良好的售后服务，赢得广大客户的青睐。短短几年中，公司在金融、电信、邮电、电力、交通、铁路、军事、教育、宾馆、娱乐场所、政府机关等领域开辟了广阔市场，并取得了较好的业绩。-->
				<br />
				<br /> 地址：北京市成海淀区 6-1-1801 <br /> 电话：0471-3246388 传真：0471-3246399<br />
				http://www.dingyin.com.cn<br /> www.nmdgyx.com<br />
				E-mail:trap@trapyx.com<br /> 客服专线：4006 110 664
			</div>
		</div>
	</div>
