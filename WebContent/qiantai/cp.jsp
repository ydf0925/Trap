						...
						<ul>
							<c:forEach items="${caseList}" var="n">
								<li>
									<Div class="tstu">
										<a
											href="${pageContext.request.contextPath}/CaseDetailServlet?id=${n.id}"><img
									...
									<div class="tswz">
										<h3>
											<a
												href="${pageContext.request.contextPath}/CaseDetailServlet?id=${n.id}"
												class="l">${n.title}</a>
										</h3>
										<p class="time">TIME: ${n.updatetime}</p>
										<p class="newxx">
											<a
												href="${pageContext.request.contextPath}/CaseDetailServlet?id=${n.id}">查看更多</a>
										</p>
									</div>
...
<p class="time">TIME:2019-10-01</p>
