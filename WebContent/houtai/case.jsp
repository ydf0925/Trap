...
<script src="<%=path%>/static/js/ht/case.js"></script>
					...
					<table id="TblGrid_table_list_2" class="EditTable ui-common-table">
						<tbody>
							<tr rowpos="1" class="FormData" id="tr_username">
								<td class="CaptionTD"><label for="username">案例标题</label></td>
								<td class="DataTD">&nbsp;
									<div class="col-sm-12">
							...
							<tr rowpos="2" class="FormData" id="tr_sex">
								<td class="CaptionTD"><label for="role">案例类别</label></td>
								<td class="DataTD">
									<div class="col-sm-12">
							...
							<tr rowpos="3" class="FormData" id="tr_password">
								<td class="CaptionTD"><label for="username">案例内容</label></td>
								<td class="DataTD">&nbsp;
									<div class="col-sm-12">
...
layui.use('upload', function(){
	  ...
	  var uploadInst = upload.render({
	    	elem: '#test1', //绑定元素
	    	url: $('#PageContext').val()+'/UploadServlet', //上传接口
	        done: function (res) {
	        	//如果上传失败
                if (res.code == 1) {
