...
<script src="<%=path%>/static/js/ht/news.js"></script>
					...
					<table id="TblGrid_table_list_2" class="EditTable ui-common-table">
						<tbody>
							<tr rowpos="1" class="FormData" id="tr_username">
								<td class="CaptionTD"><label for="username">标题</label></td>
								<td class="DataTD">&nbsp;
									<div class="col-sm-12">
							...
							<tr rowpos="2" class="FormData" id="tr_sex">
								<td class="CaptionTD"><label for="role">类别</label></td>
								<td class="DataTD">
									<div class="col-sm-12">
							...
							<tr rowpos="3" class="FormData" id="tr_password">
								<td class="CaptionTD"><label for="username">作者</label></td>
								<td class="DataTD">&nbsp;
									<div class="col-sm-12">
							...
							<tr rowpos="3" class="FormData" id="tr_password">
								<td class="CaptionTD"><label for="username">内容</label></td>
								<td class="DataTD">&nbsp;
									<div class="col-sm-12">
