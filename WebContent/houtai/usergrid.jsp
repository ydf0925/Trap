...
<script src="<%=path%>/static/js/ht/user.js"></script>
					...
					<table id="TblGrid_table_list_2" class="EditTable ui-common-table">
						<tbody>
							<tr rowpos="1" class="FormData" id="tr_username">
								<td class="CaptionTD"><label for="username">用户名</label></td>
								<td class="DataTD">&nbsp;
									<div class="col-sm-12">
										<input id="changeusername" name="username"
											class="form-control" type="text" />
									</div>
								</td>
							</tr>
							<tr hidden rowpos="2" class="FormData" id="tr_password">
								<td class="CaptionTD"><label for="username">密码</label></td>
								<td class="DataTD">&nbsp;
									<div class="col-sm-12">
							...
							<tr rowpos="4" class="FormData" id="tr_name">
								<td class="CaptionTD"><label for="username">姓名</label></td>
								<td class="DataTD">&nbsp;
									<div class="col-sm-12">
							...
							<tr rowpos="3" class="FormData" id="tr_sex">
								<td class="CaptionTD"><label for="role">性别</label></td>
								<td class="DataTD">
									<div class="col-sm-12">
